...
<body>
	...
	<section class="aboutus">
		...
		<div id="main-box">
			<h3 style="color: #8E2157;">Welcome to JETSETFLY , your trusted partner in simplifying air travel.
			...
			<div class="boxs" id="second-box">
				...
				<div class="text-info">
					...
					<br>
					<div>
						<p>JETSETFLY is a leading provider of online flight booking services,
			...
			<div class="boxs" id="Third-box">
				<div class="text-info">
					...
					<br>
					<div>
						<p>At JETSETFLY, we are committed to excellence in every aspect of our service.
