  ...
  <aside
    ...
    <div class="collapse navbar-collapse  w-auto " id="sidenav-collapse-main">
      <ul class="navbar-nav">
        ...
        <li class="nav-item">
          <a class="nav-link text-white active bg-gradient-primary" href="addNewM.php">
            <div class="text-white text-center me-2 d-flex align-items-center justify-content-center">
                    ...
                    <div class="container">
                        <?php
                            if(isset($_POST['submit']))
                            {
                                ...
                                $errors=array();
                                if (empty($fname) OR empty($email) OR empty($password) OR empty($repassword))
                                {
                                ...
                                {
                                    array_push($errors,"Password must atleat 8 characters long");
                                }
                                if ($password!==$repassword)
                                {
                                    array_push($errors,"Password must match with repeat password");
                                }
                                ...
                                if ($rowCount>0)
                                {
                                    array_push($errors,"Provided Email already exits");
                                }
                                ...
                                else
                                {
                                    ...
                                    $sql ="INSERT INTO admin_r (name,email,password) VALUES (?,?,?)";
                                    ...
                                    if ($prepare)
                                    {
                                        ...
                                        echo"<div class='alert alert-success'>New user register successfully</div>";
                                    }
                                    else
                                    {
                                        die("SomeThing Went Wrong");
                        ...
                        <form action="addNewM.php" method="POST">
